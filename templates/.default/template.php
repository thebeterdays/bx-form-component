                ...
                <div class="form-group">
                    <div class="form-row">
                        <div class="col-md-4 mb-3">
                            ...
                            <input class="form-control" type="text" placeholder="First name"
                                   id="name_<?= $arParams['TOKEN'] ?>" value="" required>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input class="form-control" type="tel" placeholder="Phone"
                                   id="phone_<?= $arParams['TOKEN'] ?>" value="" required>
                            <div class="valid-feedback">
                                Looks good!
                            </div>
                            <div class="invalid-feedback">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input class="form-control" type="email" placeholder="E-mail"
                                   id="email_<?= $arParams['TOKEN'] ?>" value="" required>
                            <div class="valid-feedback">
                                Looks good!
                            </div>
                            <div class="invalid-feedback">
                    ...
                    <div class="form-row">
                        <div class="col-md-12 mb-3">
                            ...
                            <textarea class="form-control" placeholder="Message" name="" rows="5"
                                      id="message_<?= $arParams['TOKEN'] ?>" required></textarea>
                        </div>
                        <div class="valid-feedback">
                            Looks good!
                        </div>
                    ...
                    <div class="form-row align-items-center">
                        <div class="col-md-4 mb-3 date">
                            ...
                            <input type="text" class="form-control" placeholder="Date"
                                   id="date_<?= $arParams['TOKEN'] ?>" required>
                        ...
                        <div class="col-md-2 mb-3">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input"
                                       id="checkbox_<?= $arParams['TOKEN'] ?>" required>
                                <label class="custom-control-label"
                                       for="checkbox_<?= $arParams['TOKEN'] ?>">Check</label>
                            </div>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="col-auto">
                            <button type="submit" class="btn btn-primary" id="button_<?= $arParams['TOKEN'] ?>">Submit
                            </button>
                        </div>
                    </div>
                </div>
